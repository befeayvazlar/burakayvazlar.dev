    ...
    <div class="flex flex-wrap -mx-4">
      <div class="w-full lg:w-5/12 px-4">
        <div class="hero-content">
          <h1
            class="text-dark dark:text-gray-200 font-bold text-2xl sm:text-[42px] lg:text-[40px] xl:text-[42px] leading-snug mb-6"
          >
            Burak E. Ayvazlar <br/>
            <span class="rounded-md text-amber-600">Full Stack Dev</span>.
          </h1>
          <p class="text-base mb-8 max-w-[520px]">
            7+ yıllık deneyime sahip geliştiriciyim. <br/>
            Önyüz & Arkayüz Web Geliştirici <br>
          </p>
