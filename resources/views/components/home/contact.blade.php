      ...
      <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
        <div class="max-w-[570px] mb-12 lg:mb-0">
          ...
          <p class="text-base text-body-color dark:text-gray-200 leading-relaxed mb-9">
            Deneyim ve becerilerimin ihtiyaçlarınıza uygun olduğunu düşünüyorsanız, lütfen iletişime geçiniz.
          </p>
          <div class="flex mb-8 max-w-[370px] w-full">
            ...
            <div class="w-full">
              ...
              <p class="text-base text-body-color dark:text-gray-300">burakefeayvazlar@outlook.com</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="bg-white dark:bg-slate-900 relative rounded-lg p-8 sm:p-12 shadow-lg">
          ...
          " x-on:submit.prevent="submitForm">
            <template x-if="successMessage">
              <div x-text="successMessage" class="rounded py-4 px-6 bg-green-600 text-gray-100 mb-4"></div>
            </template>
            @csrf
            <div class="mb-6">
